<a id="upholster" class="tas-select" data-fancybox data-src="#variable-upholster" data-options='{ "touch": false}' href="javascript:;">
	<span class="label">Upholster:</span>
...
<div class="content-wrapper">
	<div class="page-title">
		<h2>SELECT UPHOLSTER</h2>
	</div>
	<ul class="variation-filter">
		<?php 
			foreach ($upholster as $key => $value) {
				echo '<li><a href="javascript:;" class="square-btn" data-filter-values="'.$key.'">'.$key.'</a></li>';
			}
		?>	
	</ul>
